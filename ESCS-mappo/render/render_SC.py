...
C) 尽量保持 PDF 为矢量（关闭散点/轨迹 rasterized；若叠加位图底图，PDF 会包含该位图）。
...
def main(argv):
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default=r"../results/SCEnv/1actor/Discrete/r_mappo/check/run2/models",
