...
def main(argv):
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default=r"../results/TCEnv/1actor/Discrete/r_mappo/check/run2/models",
    ...
    rx_slots, rx_vals = build_avg_rx_series(parsed, reduce="mean")  # 用总接收量可改为 "sum"
    ...
    # 出图（PNG/PDF/SVG/EPS），横轴均为 Time slot (T)
    if sp_slots.size:
